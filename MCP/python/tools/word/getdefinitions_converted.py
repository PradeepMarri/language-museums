"""
MCP tool for Return definitions for a word
"""
...
def get_word_json_word_definitions(word: str, partOfSpeech: str, includeRelated: str, useCanonical: str, includeTags: str, limit: str, sourceDictionaries: str) -> str:
    """
