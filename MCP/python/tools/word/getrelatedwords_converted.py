"""
MCP tool for Given a word as a string, returns relationships from the Word Graph
"""
...
def get_word_json_word_related_words(word: str, useCanonical: str, relationshipTypes: str, limitPerRelationshipType: str) -> str:
    """
