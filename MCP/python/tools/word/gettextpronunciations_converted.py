"""
MCP tool for Returns text pronunciations for a given word
"""
...
def get_word_json_word_pronunciations(word: str, useCanonical: str, sourceDictionary: str, typeFormat: str, limit: str) -> str:
    """
