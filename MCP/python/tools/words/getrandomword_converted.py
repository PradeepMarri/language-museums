"""
MCP tool for Returns a single random WordObject
"""
...
def get_words_json_random_word(hasDictionaryDef: str, includePartOfSpeech: str, excludePartOfSpeech: str, minCorpusCount: str, maxCorpusCount: str, minDictionaryCount: str, maxDictionaryCount: str, minLength: str, maxLength: str) -> str:
    """
