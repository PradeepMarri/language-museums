"""
MCP tool for Returns an array of random WordObjects
"""
...
def get_words_json_random_words(hasDictionaryDef: str, includePartOfSpeech: str, excludePartOfSpeech: str, sortBy: str, sortOrder: str, minCorpusCount: str, maxCorpusCount: str, minDictionaryCount: str, maxDictionaryCount: str, minLength: str, maxLength: str, limit: str) -> str:
    """
