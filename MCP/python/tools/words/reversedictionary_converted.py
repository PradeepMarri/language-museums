"""
MCP tool for Reverse dictionary search
"""
...
def get_words_json_reverse_dictionary(query: str, findSenseForWord: str, includeSourceDictionaries: str, excludeSourceDictionaries: str, includePartOfSpeech: str, excludePartOfSpeech: str, expandTerms: str, includeTags: str, sortBy: str, sortOrder: str, skip: str, minCorpusCount: str, maxCorpusCount: str, minLength: str, maxLength: str, limit: str) -> str:
    """
